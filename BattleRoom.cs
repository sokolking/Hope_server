...
public partial class BattleRoom
{
    ...
    {
        TopLeftHex = HexTagFromColRow(_activeMinCol, _activeMinRow),
        TopRightHex = HexTagFromColRow(_activeMaxCol, _activeMinRow),
        BottomLeftHex = HexTagFromColRow(_activeMinCol, _activeMaxRow),
