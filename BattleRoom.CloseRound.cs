                ...
                foreach (var uid in order)
                {
                    ...
                    else if (string.Equals(actionType, BattleActionTypes.Attack, StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        else
                        {
                            ...
                            bool isMelee = string.Equals(weaponCategory, "cold", StringComparison.OrdinalIgnoreCase);
                            if (isMelee && dist > 1)
                            {
...
FinishAttackAction:
        ...
        _ = ApplyZoneShrinkIfNeeded(RoundIndex, mapUpdates, results);
